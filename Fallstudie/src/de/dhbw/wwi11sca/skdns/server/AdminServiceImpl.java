...
AdminService{
	...
	public List<User> getUser() {
		...
		// damit werden nur die User angezeigt, deren Passwort geändert werden soll,
		// da der User dieses vergessen hat
		Datastore ds = new Morphia().createDatastore(getMongo(), "skdns");
		List<User> dbUser = ds.createQuery(User.class).filter("forgottenPassword =", true).asList();
		return dbUser;
	}
	...
	public void saveUser(User newUser) {
		...
		// anschließend true zurückgeben, damit dem Admin angezeigt werden kann, dass das Erzeugen erfolgreich war
	}
	...
	public Admin getStats() {
		...
		// alle in der Datenbank vorhandenen User (außer Admin) sollen gezählt werden und in
